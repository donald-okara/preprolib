...
def evaluate_model(curr_model, X_test, y_test):
    ...
    accuracy = accuracy_score(y_test_1d, predictions_1d)
    precision = precision_score(y_test_1d, predictions_1d, average='weighted')
    recall = recall_score(y_test_1d, predictions_1d, average='weighted')
    f1 = f1_score(y_test_1d, predictions_1d, average='weighted')
